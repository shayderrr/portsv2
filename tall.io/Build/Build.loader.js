function createUnityInstance(e, t, r) {
    ...
    function d(e) {
        return new Promise(function(t, r) {
            s(e);
            var o = f.companyName && f.productName ? new f.XMLHttpRequest({
                companyName: f.companyName,
                productName: f.productName,
                cacheControl: f.cacheControl(f[e])
            }) : new XMLHttpRequest;
            o.open("GET", f[e]), o.responseType = "arraybuffer", o.addEventListener("progress", function(t) {
                s(e, t)
    ...
    var w = {
        ...
        Quit: function() {
            return new Promise(function(t, r) {
                f.shouldQuit = !0, f.onQuit = t, p.forEach(function(t) {
            ...
            require: function(e) {
                var t = {
                    ...
                    "zlib/inflate.js": function(e, t, r) {
                        ...
                        function a(e) {
                            var t;
                            return e && e.state ? (t = e.state, e.total_in = e.total_out = t.total = 0, e.msg = "", t.wrap && (e.adler = 1 & t.wrap), t.mode = D, t.last = 0, t.havedict = 0, t.dmax = 32768, t.head = null, t.hold = 0, t.bits = 0, t.lencode = t.lendyn = new g.Buf32(be), t.distcode = t.distdyn = new g.Buf32(me), t.sane = 1, t.back = -1, T) : O
                        }
                        ...
                        function f(e, t) {
                            var r, o, a, i, s, l, d, f, h, p, b, m, w, be, me, we, ge, ve, ye, ke, xe, _e, Se, Ee, Ce = 0,
                                Ue = new g.Buf8(4),
                                Le = [16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15];
                            if (!e || !e.state || !e.output || !e.input && 0 !== e.avail_in) return O;
                            r = e.state, r.mode === K && (r.mode = Y), s = e.next_out, a = e.output, d = e.avail_out, i = e.next_in, o = e.input, l = e.avail_in, f = r.hold, h = r.bits, p = l, b = d, _e = T;
                            e: for (;;) switch (r.mode) {
                                case D:
                                    if (0 === r.wrap) {
                                        r.mode = Y;
                                ...
                                case j:
                                    if (2048 & r.flags) {
                                        if (0 === l) break e;
                                        m = 0;
                                        do xe = o[i + m++], r.head && xe && r.length < 65536 && (r.head.name += String.fromCharCode(xe)); while (xe && m < l);
                                ...
                                case W:
                                    if (4096 & r.flags) {
                                        if (0 === l) break e;
                                        m = 0;
                                        do xe = o[i + m++], r.head && xe && r.length < 65536 && (r.head.comment += String.fromCharCode(xe)); while (xe && m < l);
                                        if (512 & r.flags && (r.check = y(r.check, o, m, i)), l -= m, i += m, xe) break e
                    ...
                    "zlib/inffast.js": function(e, t, r) {
                        ...
                        t.exports = function(e, t) {
                            var r, a, i, s, l, d, u, c, f, h, p, b, m, w, g, v, y, k, x, _, S, E, C, U, L;
                            r = e.state, a = e.next_in, U = e.input, i = a + (e.avail_in - 5), s = e.next_out, L = e.output, l = s - (t - e.avail_out), d = s + (e.avail_out - 257), u = r.dmax, c = r.wsize, f = r.whave, h = r.wnext, p = r.window, b = r.hold, m = r.bits, w = r.lencode, g = r.distcode, v = (1 << r.lenbits) - 1, y = (1 << r.distbits) - 1;
                            e: do {
                                m < 15 && (b += U[a++] << m, m += 8, b += U[a++] << m, m += 8), k = w[b & v];
                                t: for (;;) {
                                    if (x = k >>> 24, b >>>= x, m -= x, x = k >>> 16 & 255, 0 === x) L[s++] = 65535 & k;
                                    else {
                                        if (!(16 & x)) {
                                            if (0 === (64 & x)) {
                                                k = w[(65535 & k) + (b & (1 << x) - 1)];
                    ...
                    "zlib/inftrees.js": function(e, t, r) {
                        ...
                        t.exports = function(e, t, r, p, b, m, w, g) {
                            ...
                            if (e === s ? (F = j = w, S = 19) : e === l ? (F = u, P -= 257, j = c, W -= 257, S = 256) : (F = f, j = h, S = -1), z = 0, R = 0, T = B, _ = m, A = H, I = 0, k = -1, D = 1 << H, x = D - 1, e === l && D > a || e === d && D > i) return 1;
                            for (;;) {
                                E = T - I, w[R] < S ? (C = 0, U = w[R]) : w[R] > S ? (C = j[W + w[R]], U = F[P + w[R]]) : (C = 96, U = 0), v = 1 << T - I, y = 1 << A, B = y;
                                do y -= v, b[_ + (z >> I) + y] = E << 24 | C << 16 | U | 0; while (0 !== y);
                                for (v = 1 << T - 1; z & v;) v >>= 1;
                                if (0 !== v ? (z &= v - 1, z += v) : z = 0, R++, 0 === --Z[T]) {
                                    if (T === O) break;
                                    T = t[r + w[R]]
                                }
                                if (T > H && (z & x) !== k) {
                            ...
                            return 0 !== z && (b[_ + z] = T - I << 24 | 64 << 16 | 0), g.bits = H, 0
                        }
                    }
                };
    ...
    return new Promise(function(e, t) {
        f.SystemInfo.hasWebGL ? 1 == f.SystemInfo.hasWebGL ? t('Your browser does not support graphics API "WebGL 2.0" which is required for this content.') : f.SystemInfo.hasWasm ? (1 == f.SystemInfo.hasWebGL && f.print('Warning: Your browser does not support "WebGL 2.0" Graphics API, switching to "WebGL 1.0"'), f.startupErrorHandler = t, r(0), f.postRun.push(function() {
